...
predsDF[,2:3]
#Nice it Up!
predsDF2 = data.frame(Survived=round(predsDF[,c(2)],2),PClass = predsDF$Pclass)
predsDF2
```
...
CM = confusionMatrix(table(predict(model,testTitanic[,c("Age","Pclass")]),testTitanic$Survived), mode = "everything")
CM
```
